...
const Chat = () => {
  ...
  // Desplazamiento automático hacia el final del chat cuando se agregue un nuevo mensaje
  useEffect(() => {
  ...
  return (
    <div className="p-4">
      ...
      <div
        ...
        className="bg-gray-100 p-4 rounded-lg max-h-96 overflow-y-auto mb-4"
      >
        {chat.map((message) => (
